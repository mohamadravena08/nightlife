                ...
                <tr>
                    ...
                    <td>
                        <a href="/"> <button type="button" class="btn btn-default">
                                <span class="fa fa-shopping-cart"></span> Pesan Yang Lain
                            </button>
                        </a>
                        <a href="/"> <button type="button" class="btn btn-default">
                                <span class="fa fa-shopping-cart"></span> Pay with Bank Transfer
                            </button>
                        </a>
                    </td>
<td class="col-md-2">
    <form action="/checkout" method="POST">
        ...
        <script
                ...
                data-name="Liburanku"
                data-description="Pembayaran Paket Liburanku"
                data-image=""
                data-locale="auto">
        </script>
    </form>
